...
use Infra\Repo\Item\ShowItemDbRepository;
use Infra\Repo\Item\ItemListDbRepository;
use Infra\Repo\Item\ItemDbRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ShowItemRepository::class, ShowItemDbRepository::class);
        $this->app->bind(ItemListRepository::class, ItemListDbRepository::class);
        $this->app->bind(ItemRepository::class, ItemDbRepository::class);
